...
import com.xsoft.xchoolar.entities.ESexe;
import com.xsoft.xchoolar.entities.ESitMatrim;

@Entity
public class Employe extends AbstractEntityCode{
	/**
	 * 
	 */
	...
	public Employe(String matricule, String nom, String prenom,  ESexe sexe, Date dateNaissance, Date dateEmbauche, String quartier,
	...
	public Employe(String matricule, String nom, String prenom, ESexe sexe, Date dateNaissance, Date dateEmbauche,
	...
	public String toString() {
		return String.format(
				"Employe [matricule=%s, nom=%s, prenom=%s, sexe=%s, dateNaissance=%s, dateEmbauche=%s, quartier=%s, numerosCni=%s, dateDelivranceCni=%s, telephone1=%s]",
				super.getCode(), nom, prenom, sexe, dateNaissance, dateEmbauche, quartier, numerosCni, dateDelivranceCni,
				telephone1);
	}
	/**
	 * @return the nom
